...
const packs = [_]BuiltinPack{
    .{
        .dir_name = "zsc_modern_ai",
        .files = &[_]PackFile{
            .{ .rel_path = "manifest.json", .bytes = @embedFile("builtin_packs_data/zsc_modern_ai/manifest.json") },
            .{ .rel_path = "layouts/workspace.json", .bytes = @embedFile("builtin_packs_data/zsc_modern_ai/layouts/workspace.json") },
            .{ .rel_path = "profiles/phone.json", .bytes = @embedFile("builtin_packs_data/zsc_modern_ai/profiles/phone.json") },
            .{ .rel_path = "profiles/tablet.json", .bytes = @embedFile("builtin_packs_data/zsc_modern_ai/profiles/tablet.json") },
            .{ .rel_path = "profiles/fullscreen.json", .bytes = @embedFile("builtin_packs_data/zsc_modern_ai/profiles/fullscreen.json") },
            .{ .rel_path = "tokens/base.json", .bytes = @embedFile("builtin_packs_data/zsc_modern_ai/tokens/base.json") },
            .{ .rel_path = "tokens/light.json", .bytes = @embedFile("builtin_packs_data/zsc_modern_ai/tokens/light.json") },
            .{ .rel_path = "tokens/dark.json", .bytes = @embedFile("builtin_packs_data/zsc_modern_ai/tokens/dark.json") },
            .{ .rel_path = "styles/components.json", .bytes = @embedFile("builtin_packs_data/zsc_modern_ai/styles/components.json") },
        },
    },
};
