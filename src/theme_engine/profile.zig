//! UI profile definitions for different device/form-factor targets
...
pub const PlatformCaps = struct {
    ...
    /// Get default capabilities for the current target
...
/// Get profile ID from label string
...
/// Get label string from profile ID
...
/// Resolve profile based on capabilities and screen size
...
/// Get default profile settings for a profile ID
